...
class ArticleDaoImpl(private val context: Context? = null): ArticleDao {
    ...
    override fun getImportantPeoples(): List<Article> {
        ...
        articlesList.add(Article
            ...
            header = Header(content = hashMapOf(PROFESSIONS to "badacz, astronom, lekarz",
                LIVE_YEARS to "1473 - 1543", NATIONALITY to "polska")),
        ...
        articlesList.add(Article
            ...
            header = Header(content = hashMapOf(PROFESSIONS to "malarz, architekt, rzeźbiarz, wynalazca",
                LIVE_YEARS to "1452 - 1519", NATIONALITY to "włoska")),
        ...
        articlesList.add(Article
            ...
            header = Header(content = hashMapOf(PROFESSIONS to "rzeźbiarz, malarz, poeta, architekt",
                LIVE_YEARS to "1475 - 1564", NATIONALITY to "włoska")),
        ...
        articlesList.add(Article
            ...
            header = Header(content = hashMapOf(PROFESSIONS to "malarz, architekt",
                LIVE_YEARS to "1483 - 1520", NATIONALITY to "włoska")),
        ...
        articlesList.add(Article
            ...
            header = Header(content = hashMapOf(PROFESSIONS to "filolog, filozof, pedagog")),
        ...
        articlesList.add(Article
            ...
            objectId = "P6",
            source = Source(srcDescription = MAIN_TEXT, page = CULTURE_PL),
            header = Header(content = hashMapOf(PROFESSIONS to "filozof, fizyk, astronom")),
        ...
        articlesList.add(Article
            ...
            objectId = "P10",
            source = Source(srcDescription = MAIN_TEXT, page = CULTURE_PL),
            header = Header(content = hashMapOf(PROFESSIONS to "poeta, dramaturg, aktor")),
        ...
        articlesList.add(Article
            ...
            objectId = "P8",
            source = Source(srcDescription = MAIN_TEXT, page = CULTURE_PL),
            header = Header(content = hashMapOf(PROFESSIONS to "poeta, tłumacz")),
        ...
        articlesList.add(Article
            ...
            header = Header(content = hashMapOf(PROFESSIONS to "poeta",
                LIVE_YEARS to "1550 - 1581", NATIONALITY to "polska")),
        ...
        articlesList.add(Article
            ...
            objectId = "P9",
            source = Source(srcDescription = MAIN_TEXT, page = CULTURE_PL),
            header = Header(content = hashMapOf(PROFESSIONS to "rzeźbiarz, grafik, malarz")),
    ...
    override fun getImportantArts(): List<Article> {
        ...
        articlesList.add(Article
            ...
            header = Header(content = hashMapOf(CREATEOR to "Leonardo da Vinci",
                CREATE_YEAR to "1503 - 1519", ART_PLACE to "Luwr, Paryż")),
        ...
        articlesList.add(Article
            ...
            listOfRelatedArticlesIds = listOf("P4"),
            header = Header(content = hashMapOf(CREATEOR to "Leonardo da Vinci",
                CREATE_YEAR to "1495 - 1498",
                ART_PLACE to "Muzeum Santia Maria delle Grazie, Mediolan")),
        ...
        articlesList.add(Article
            ...
            header = Header(content = hashMapOf(CREATEOR to "Michał Anioł",
                CREATE_YEAR to "1501 - 1504",
                ART_PLACE to "Galleria dell'Accademia, Florencja")),
        ...
        articlesList.add(Article
            ...
            header = Header(content = hashMapOf(CREATEOR to "Sandro Botticelli",
                CREATE_YEAR to "ok. 1485",
                ART_PLACE to "Galeria Uffizi, Włochy")),
        ...
        articlesList.add(Article
            ...
            objectId = "A5",
            source = Source(srcDescription = MAIN_TEXT, page = CULTURE_PL),
            header = Header(content = hashMapOf(CREATEOR to "Rafael Santi")),
        ...
        articlesList.add(Article
            ...
            header = Header(content = hashMapOf(CREATEOR to "Mikołaj Kopernik")),
        ...
        articlesList.add(Article
            ...
            header = Header(content = hashMapOf(CREATEOR to "Johannes Gutenberg")),
    ...
    override fun getImportantEvents(): List<Article> {
        ...
        articlesList.add(Article
            ...
            header = Header(content = hashMapOf(TIME to "1309 - 1377",
                PLACE to "Awinion, Francja")),
        ...
        articlesList.add(Article
            ...
            header = Header(content = hashMapOf(TIME to "2 kwietnia - 29 maja 1453",
                    PLACE to "Konstantynopol")),
        ...
        articlesList.add(Article
            ...
            header = Header(content = hashMapOf(EXPLORER to "Krzysztof Kolumb",
                    DATE to "12 października 1492")),
    ...
    override fun getOtherEras(): List<Article> {
        ...
        articlesList.add(Article
            ...
            header = Header(content = hashMapOf(TIME_FRAME_ITALY to "XIV w. - XVI w.",
                TIME_FRAME_EUROPE to "koniec XV w. - koniec XVI w.",
                TIME_FRAME_POLAND to "XVI w. - lata 30. XVII w.")),
        ...
        articlesList.add(Article
            ...
            header = Header(content = hashMapOf(TIME_FRAME_EUROPE to "V w. - XV w.")),
        ...
        articlesList.add(Article
            ...
            header = Header(content = hashMapOf(TIME_FRAME to "koniec XVI w. - XVIII w.")),
        ...
        articlesList.add(Article
            ...
            header = Header(content = hashMapOf(TIME_FRAME to "koniec XVII w. - początek XIX w.")),
        ...
        articlesList.add(Article
            ...
            header = Header(content = hashMapOf(TIME_FRAME to "lata 90. XVIII w. - lata 40. XIX w.")),
    ...
    companion object{
        ...
        const val NAUKAWPOLSCE_PAP_PL = "naukawpolsce.pap.pl"
        const val TURYSTYKA_TORUN_PL = "turystyka.torun.pl"
        const val TORUNTOUR_PL = "toruntour.pl"
        const val WIADOMOSCI_ONET_PL = "wiadomosci.onet.pl"
        const val ITINARI_COM = "itinari.com"
        const val DZIEJE_PL = "dzieje.pl"
        const val TURYSTYKA_WP_PL = "turystyka.wp.pl"
