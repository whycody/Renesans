...
class ArticleDaoImpl: ArticleDao {
    ...
    override fun getImportantPeoples(): List<Article> {
        ...
        articlesList.add(Article
            ...
            tour = Tour("Mikołaj Kopernik", listOf(PhotoArticle(objectId = "T0_0", lat = 53.009311, lng = 18.603962, title = "Miejsce urodzenia", paragraph = Paragraph(content = "19 lutego 1473 najprawdopodobniej urodził się Mikołaj Kopernik, w rodzinie kupca Mikołaja i Barbary pochodzącej z rodziny Watzenrode."), photo = Photo(description = "Dom Mikołaja Kopernika")),
                PhotoArticle(objectId = "T0_1", lat = 53.010546, lng = 18.605117, title = "Miejsce przeprowadzki (kamienica pierwsza od prawej)", paragraph = Paragraph(content = "W 1480 r. Kopernikowie przeprowadzili się z domu przy ulicy św. Anny, kamienica nazywana jest także Lazurową i stoi przy Rynku Staromiejskim 36."), photo = Photo(description = "Kamienica pod Lwem")),
                PhotoArticle(objectId = "T0_2", lat = 53.009381, lng = 18.606256, title = "Pierwsza szkoła", paragraph = Paragraph(content = "Najprawdopodobniej Mikołaj Kopernik ukończył pierwsze nauki - w szkole parafialnej przy kościele śś. Janów w Toruniu."), photo = Photo(description = "Bazylika katedralna")),
                PhotoArticle(objectId = "T0_3", lat = 50.060948, lng = 19.934106, title = "Miejsce studiów", paragraph = Paragraph(content = "Dzięki protekcji Łukasza Watzenrodego w roku 1491 Andrzej i Mikołaj Kopernikowie rozpoczęli studia."), photo = Photo(description = "Uniwersytet Jagielloński")),
                PhotoArticle(objectId = "T0_4", lat = 44.496206, lng = 11.354158, title = "Miejsce studiów", paragraph = Paragraph(content = "Dzięki staraniom wuja Łukasza w 1496 r. rozpoczął studia prawnicze, wpisując się w styczniu 1497 r. do albumu nacji niemieckiej bolońskiego Uniwersytetu Jurystów."), photo = Photo(description = "Uniwersytet Boloński")),
                ...
                PhotoArticle(objectId = "T0_7", lat = 45.406736, lng = 11.877444, title = "Miejsce studiów", paragraph = Paragraph(content = "Kopernik rozpoczął swoje kolejne studia, na kierunku medycyny. Najprawdopodobniej uzyskał stopień licencjata, który później pozwalał mu na prowadzenie praktyki lekarskiej."), photo = Photo(description = "Uniwersytet w Padwie")),
                PhotoArticle(objectId = "T0_8", lat = 54.125747, lng = 20.583082, title = "Miejsce pobytu", paragraph = Paragraph(content = "W 1507 r., po kilku latach pobytu w Polsce z Łukaszem Watzenrode, astronom został na stałe skierowany, by wspierać swojego wuja."), photo = Photo(description = "Lidzbark")))
            )
        ))
        articlesList.add(Article
